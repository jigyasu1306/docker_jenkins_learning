...
pages = []
for i in range(5):
    pages.append(tk.Frame(root, bg="#ffffff"))
...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"C:\IIIT\Minor\SEM6\Facial-Recognition-for-Crime-Detection-master\img\back.png")
    back_button = tk.Button(pages[pageNo], image=back_img, bg="#ffffff", bd=0, highlightthickness=0,
           activebackground="#ffffff", command=goBack)
    back_button.image = back_img
    back_button.place(x=10, y=10)

    heading = tk.Label(pages[pageNo], fg="white", bg="#ffffff", font="Arial 20 bold", pady=10)
    heading.pack()

    content = tk.Frame(pages[pageNo], bg="#ffffff", pady=20)
    content.pack(expand="true", fill="both")

    left_frame = tk.Frame(content, bg="#ffffff")
    left_frame.grid(row=0, column=0, sticky="nsew")

    right_frame = tk.LabelFrame(content, text="Detected Criminals", bg="#ffffff", font="Arial 20 bold", bd=4,
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file=r"C:\IIIT\Minor\SEM6\Facial-Recognition-for-Crime-Detection-master\img\previous.png")
        next_img = tk.PhotoImage(file=r"C:\IIIT\Minor\SEM6\Facial-Recognition-for-Crime-Detection-master\img\next.png")
...
def getPage1():
    ...
    basicPageSetup(1)
    heading.configure(text="Register Criminal", fg="black", bg="#ffffff")
    right_frame.configure(text="Enter Details", fg="black", bg="#ffffff")

    btn_grid = tk.Frame(left_frame, bg="#ffffff")
    btn_grid.pack()

    tk.Button(btn_grid, text="Select Images", command=lambda: selectMultiImage(opt_menu, menu_var), font="Arial 15 bold", bg="#0066ac",
           fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#ffffff",
    ...
    scrollbar = tk.Scrollbar(right_frame, command=canvas.yview, width=20, troughcolor="#ffffff", bd=0,
                          activebackground="#ffffff", bg="#0066ac", relief="raised")
    scrollbar.pack(side="left", fill="y")

    scroll_frame = tk.Frame(canvas, bg="#ffffff", pady=20)
    ...
    tk.Label(scroll_frame, text="* Required Fields", bg="#ffffff", fg="red", font="Arial 13 bold").pack()
    # Adding Input Fields
    ...
    for i, field in enumerate(input_fields):
        ...
        label = tk.Text(row, width=20, height=1, bg="#ffffff", fg="#000000", font="Arial 13", highlightthickness=0, bd=0)
        ...
        if(i != ip_len-1):
            ...
            opt_menu.configure(font="Arial 13", bg="#0066ac", fg="white", bd=0, highlightthickness=0, activebackground="#90ceff")
    ...
    tk.Button(scroll_frame, text="Register", command=lambda: register(entries, required, menu_var), font="Arial 15 bold",
           bg="#0066ac", fg="white", pady=10, padx=30, bd=0, highlightthickness=0, activebackground="#ffffff",
...
def getPage2():
    ...
    tk.Button(btn_grid, text="Select Image", command=selectImage, font="Arial 15 bold", padx=20, bg="#0066ac",
            fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#ffffff",
            activeforeground="white").grid(row=0, column=0, padx=25, pady=25)
    tk.Button(btn_grid, text="Recognize", command=startRecognition, font="Arial 15 bold", padx=20, bg="#0066ac",
           fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#ffffff",
...
def getPage4(path):
    ...
    btn_grid = tk.Frame(right_frame, bg="#ffffff")
    btn_grid.pack()
...
def getPage3():
    ...
    tk.Button(btn_grid, text="Select Video", command=selectvideo, font="Arial 15 bold", padx=20, bg="#0066ac",
                fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#ffffff",
                activeforeground="white").grid(row=0, column=0, padx=25, pady=25)
...
def liveVideo():
    ...
    tk.Button(btn_grid, text="Live Video", command=cameraDetection, font="Arial 15 bold", padx=20, bg="#0066ac",
                fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#ffffff",
                activeforeground="white").grid(row=0, column=0, padx=25, pady=25)
...
def cameraDetection():
    ...
    #facedetect = cv2.CascadeClassifier(r'C:\IIIT\Minor\SEM6\Facial-Recognition-for-Crime-Detection-master\haarcascade_frontalface_default.xml')
    ...
    #thread_event = threading.Event()
    #thread = threading.Thread(target=videoLoop, args=(0,model, names))
    #thread.start()
...
######################################## Home Page ####################################
tk.Label(pages[0], text="Face Recognition System for Criminal Detection", fg="black", bg="#ffffff",
      font="Arial 25 bold", pady=30).pack()

logo = tk.PhotoImage(file = r"C:\IIIT\Minor\SEM6\Facial-Recognition-for-Crime-Detection-master\img\logo.png")
tk.Label(pages[0], image=logo, bg="#ffffff").pack(side='left')

btn_frame = tk.Frame(pages[0], bg="#ffffff", pady=30)
btn_frame.pack()

tk.Button(btn_frame, text="Input Video", command=liveVideo)
...
for btn in btn_frame.winfo_children():
    btn.configure(font="Arial 20", width=17, bg="#0066ac", fg="white",
        pady=15, bd=0, highlightthickness=0, activebackground="#ffffff", activeforeground="white")
    btn.pack(pady=30)
